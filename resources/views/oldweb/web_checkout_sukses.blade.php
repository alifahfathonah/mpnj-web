            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shortcode_module_title">
                        ...
                        <h3>Setelah melakukan pembayaran, pastikan anda mengkonfirmasi pembayaran anda dengan mengunggah foto bukti transafer <a href="{{ URL::to('konfirmasi') }}">disini</a> agar transaksi anda segera di proses. Terima Kasih :D</h3>
                    </div>
                </div>
            </div>
        </div>
