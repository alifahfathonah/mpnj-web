...
@if($get == 'users')
<table class="messenger-list-item @if($user->id_user == $id && $id != "0") m-list-active @endif" data-contact="{{ $user->id_user }}">
    <tr data-action="0">
        {{-- Avatar side --}}
        ...
        {{-- center side --}}
        <td>
        <p data-id="{{ $type.'_'.$user->id_user }}">
            {{ strlen($user->nama_lengkap) > 12 ? trim(substr($user->nama_lengkap,0,12)).'..' : $user->nama_lengkap }}
...
{{-- -------------------- Search Item -------------------- --}}
@if($get == 'search_item')
<table class="messenger-list-item" data-contact="{{ $user->id_user }}">
    <tr data-action="0">
        {{-- Avatar side --}}
        <td>
        <div class="avatar av-m"
