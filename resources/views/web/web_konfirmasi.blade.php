                        ...
                        <form action="{{ URL::to('konfirmasi/simpan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="rekening" id="rekening" class="form-control" required>
                                    ...
                                    <option value="{{$ra->rekening_admin->id_rekening_admin}}">{{$ra->nama_bank}} -
                                        {{$ra->rekening_admin->nomor_rekening}} -
                                        {{$ra->rekening_admin->atas_nama_rekening}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <small style="color: red">{{ $errors->first('bukti_transfer') }}</small> @endif
                            </div>
