                    ...
                    <article class="card-body">
                        ...
                        <form action="{{ URL::to('konfirmasi/simpan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="kode_transaksi" type="text" class="form-control" placeholder="Isi dengan kode transaksi anda" name="kode_transaksi" value="{{  $transaksi->kode_transaksi }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama_pengirim">Nama Pengirim</label>
                                <input id="nama_pengirim" type="text" class="form-control" name="nama_pengirim" value="{{  $transaksi->pembeli->nama_lengkap }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="total_bayar">Total Bayar</label>
                                <input id="total_bayar" type="text" class="form-control" name="total_bayar" value="{{ $transaksi->total_bayar }}" readonly>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="rekening" id="rekening" class="form-control" required>
                                    ...
                                    <option value="{{$ra->id_rekening_admin}}">{{$ra->bank->nama_bank}} - {{$ra->nomor_rekening}} - {{$ra->atas_nama_rekening}}</option>
                                    @endforeach
