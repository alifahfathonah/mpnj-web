...
<head>
    ...
    <link href="{{ asset('aseets/mpnj/images/favicon.ico') }}" rel="shortcut icon" type="image/x-icon">

    <!-- jQuery -->
    <script src="{{ asset('assets/mpnj/js/jquery-2.0.0.min.js') }}" type="text/javascript"></script>

    <!-- Bootstrap4 files-->
    <script src="{{ asset('assets/mpnj/js/bootstrap.bundle.min.js') }}" type="text/javascript"></script>
    <link href="{{ asset('assets/mpnj/css/bootstrap.css') }}" rel="stylesheet" type="text/css"/>

    <!-- Font awesome 5 -->
    <link href="{{ asset('assets/mpnj/fonts/fontawesome/css/all.min.css') }}" type="text/css" rel="stylesheet">

    <!-- custom style -->
    <link href="{{ asset('assets/mpnj/css/ui.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/mpnj/css/responsive.css') }}" rel="stylesheet" type="text/css" />

    <!-- custom javascript -->
    <script src="{{ asset('assets/mpnj/js/script.js') }}" type="text/javascript"></script>
</head>
<body>
...
{{--        <div class="row">--}}
{{--            <div class="col-md-8">--}}
{{--                <div class="card-banner banner-quote overlay-gradient" style="background-image: url({{ asset('assets/mpnj/images/banners/banner9.jpg') }});">--}}
