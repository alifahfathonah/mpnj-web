                                            ...
                                            <div class="card-banner border-bottom">
                                                <div class="py-3" style="width:80%">
                                                    <div class="namaProduk-rapi">
                                                        <a href="{{ URL::to('produk/'.$lp->latestProduk->slug) }}"
                                                           class="title">
        ...
        <section class="padding-bottom">
            <div class="card card-deal">
                <div class="col-heading content-body">
                    ...
                    <div class="timer">
                        <div><span class="num" id="days">04</span>
                            <small>Hari</small>
                        </div>
                        <div><span class="num" id="hour">12</span>
                            <small>Jam</small>
                        </div>
                        <div><span class="num" id="minute">58</span>
                            <small>Menit</small>
                        </div>
                        <div><span class="num" id="second">02</span>
                            <small>Detik</small>
                        </div>
                    </div>
                </div> <!-- col.// -->
