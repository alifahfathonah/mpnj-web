                                            ...
                                            <td>
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="check"
                                                           id="check{{ $k['id_keranjang'] }}"
                                                           value="{{ $k['id_keranjang'] }}"
                                                           checked="true">
...
<div class="modal fade" id="modalIdKosong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
