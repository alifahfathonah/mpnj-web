...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Apr 2020 pada 17.58
...
(1, 'M. Ilham Surya Pratama', '085330150827', 11, 'Jawa Timur', 369, 'Kabupaten Probolinggo', 5154, 'Maron', '67267', 'Dusun Paleran RT 011 RW 003 Desa Maron Wetan', 'N', NULL, NULL, NULL, 1),
(2, 'Indra Irawanto', '085330150827', 11, 'Jawa Timur', 369, 'Kabupaten Probolinggo', 5154, 'Maron', '67276', 'Dusun Paleran RT 011 RW 003 Desa Maron Wetan', 'N', NULL, NULL, NULL, 2),
(3, 'Yolo', '085330150822', 11, 'Jawa Timur', 369, 'Kabupaten Probolinggo', 5154, 'Maron', '67276', 'Dusun Krajan II RT 03 RW 001 Desan Maron Wetan', 'N', NULL, NULL, NULL, 1);
...
(1, '1586526347', 87000, 'M. Ilham Surya Pratama', '2020-04-10 00:00:00', 'auth check.png', NULL, 2);
...
(20, '2020_03_27_102820_add_batas_transaksi_to_transaksi_table', 1);
...
INSERT INTO `pengguna` (`id_user`, `nama_lengkap`, `username`, `password`, `nomor_hp`, `foto_profil`, `email`, `status_official`, `role`, `nama_toko`, `foto_toko`, `rating`, `saldo`, `status`, `alamat_utama`, `remember_token`, `created_at`, `updated_at`, `alamat_toko`) VALUES
(1, 'M. Ilham Surya Pratama', 'ilham', '$2y$10$mLRBFK6.Kz1RBs6.IFA/a.qLnIN8WCxtYtsIjfXo3amYdHSGVlQJu', '085330150827', 'ZQ8ld7RowEZUgIV.jpg', 'ilhamsurya26@gmail.com', 'santri', 'konsumen', '', NULL, NULL, 0, 'aktif', NULL, NULL, NULL, NULL, NULL),
(2, 'Indra Irawanto', 'indra', '$2y$10$ziubwfftcm6sWiYwzQQAD.kvZSI9EU.kVvu5qlL13tOiKRg4sbtBC', '085330150822', 'DRoqSUBVRK1Yhap.png', 'indra@gmail.com', 'santri', 'pelapak', 'Dunia Sepatu', 'DRoqSUBVRK1Yhap.png', '0', 0, 'aktif', NULL, NULL, '2020-04-08 17:00:00', NULL, NULL),
(3, 'Hafid Masruri', 'yolo', '4fded1464736e77865df232cbcb4cd19', '085330150826', NULL, 'hafid@gmail.com', 'santri', 'pelapak', 'Dunia Laptop', NULL, NULL, 0, 'aktif', NULL, NULL, NULL, NULL, NULL),
(5, 'Luthfi N', 'luthfi', 'luthfi', '085330150824', NULL, 'luthfi@gmail.com', 'santri', 'pelapak', 'Elektronik World', NULL, NULL, 0, 'aktif', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `transaksi` (`id_transaksi`, `kode_transaksi`, `user_id`, `waktu_transaksi`, `total_bayar`, `proses_pembayaran`, `created_at`, `updated_at`, `batas_transaksi`) VALUES
(1, '1586526347', 1, '2020-04-10 20:45:47', 87000, 'sudah', NULL, NULL, '2020-04-11 20:45:47');
...
INSERT INTO `transaksi_detail` (`id_transaksi_detail`, `transaksi_id`, `produk_id`, `jumlah`, `harga_jual`, `diskon`, `kurir`, `service`, `ongkir`, `etd`, `sub_total`, `status_order`, `user_id`, `created_at`, `updated_at`) VALUES
(2, 1, 1, 1, 80000, 0, 'jne', 'CTC', 7000, '3-6', 87000, 'Menunggu Konfirmasi', 2, NULL, NULL);
...
INSERT INTO `users` (`id_user`, `nama_lengkap`, `username`, `password`, `nomor_hp`, `foto_profil`, `email`, `status_official`, `role`, `nama_toko`, `foto_toko`, `rating`, `saldo`, `status`, `alamat_utama`, `remember_token`, `created_at`, `updated_at`, `alamat_toko`) VALUES
(1, 'M. Ilham Surya Pratama', 'ilham', '$2y$10$VHGK444JW5o5Xq7zc/cHAuf7OFqp7eEH4YjYhMTygRI39t9sZXMN6', '085330150827', 'ZQ8ld7RowEZUgIV.jpg', 'ilhamsurya26@gmail.com', 'santri', 'konsumen', NULL, NULL, NULL, 0, 'aktif', 3, NULL, '2020-04-09 17:00:00', '2020-04-10 14:48:16', NULL),
(2, 'Indra Irawanto', 'indra', '$2y$10$ziubwfftcm6sWiYwzQQAD.kvZSI9EU.kVvu5qlL13tOiKRg4sbtBC', '085330150822', 'DRoqSUBVRK1Yhap.png', 'indra@gmail.com', 'santri', 'pelapak', 'Dunia Sepatu', 'DRoqSUBVRK1Yhap.png', '0', 0, 'aktif', 2, NULL, '2020-04-08 17:00:00', NULL, NULL),
(3, 'Hafid Masruri', 'yolo', '4fded1464736e77865df232cbcb4cd19', '085330150826', NULL, 'hafid@gmail.com', 'santri', 'pelapak', 'Dunia Laptop', NULL, NULL, 0, 'aktif', NULL, NULL, '2020-04-09 17:00:00', NULL, NULL),
(5, 'Luthfi N', 'luthfi', 'luthfi', '085330150824', NULL, 'luthfi@gmail.com', 'santri', 'pelapak', 'Elektronik World', NULL, NULL, 0, 'aktif', NULL, NULL, '2020-04-09 17:00:00', NULL, NULL);
...
ALTER TABLE `produk`
  ...
  ADD KEY `produk_user_id_foreign` (`user_id`) USING BTREE;
...
--
ALTER TABLE `alamat`
  MODIFY `id_alamat` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `kategori_produk`
  MODIFY `id_kategori_produk` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
